...
void ovl_path_upper(struct dentry *dentry, struct path *path)
{
	...
	path->dentry = ovl_upperdentry_dereference(OVL_I(d_inode(dentry)));
}
...
struct dentry *ovl_dentry_real(struct dentry *dentry)
{
	...
	realdentry = ovl_upperdentry_dereference(OVL_I(d_inode(dentry)));
	if (!realdentry)
...
struct inode *ovl_inode_real(struct inode *inode, bool *is_upper)
{
	...
	return upperdentry ? d_inode(upperdentry) : OVL_I(inode)->lower;
}
